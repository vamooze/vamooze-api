...
export const businessSchema = Type.Object(
  {
    ...
    phone_number: Type.String({ pattern: PHONE_REGEX}),
    ...
    primary_color: Type.Optional(Type.String()),
    secondary_color: Type.Optional(Type.String()),
    tertiary_color: Type.Optional(Type.String()),
    launcher_icon: Type.Optional(Type.String()),
    createdBy : Type.Optional(Type.Number()),
    owner: Type.Optional(Type.Number()),
  },
...
export const businessExternalResolver = resolve<
  Business,
  HookContext<BusinessService>
>({});

// Schema for creating new entries
export const businessDataSchema = Type.Pick(
  businessSchema,
  [
    "name",
    "slug",
...
export const businessDataValidator = getValidator(
  businessDataSchema,
  dataValidator
);
export const businessDataResolver = resolve<
  Business,
  HookContext<BusinessService>
>({});
...
export const businessPatchValidator = getValidator(
  businessPatchSchema,
  dataValidator
);
export const businessPatchResolver = resolve<
  Business,
  HookContext<BusinessService>
>({});
...
export const businessQueryValidator = getValidator(
  businessQuerySchema,
  queryValidator
);
export const businessQueryResolver = resolve<
  BusinessQuery,
  HookContext<BusinessService>
>({});
