...
const user = (app) => {
    ...
    app.service(users_shared_1.userPath).hooks({
        ...
        before: {
            ...
            patch: [hashPassword('password'), (0, authentication_1.authenticate)('jwt'), schema_1.hooks.validateData(users_schema_1.userPatchValidator), schema_1.hooks.resolveData(users_schema_1.userPatchResolver)],
            remove: []
        },
        after: {
